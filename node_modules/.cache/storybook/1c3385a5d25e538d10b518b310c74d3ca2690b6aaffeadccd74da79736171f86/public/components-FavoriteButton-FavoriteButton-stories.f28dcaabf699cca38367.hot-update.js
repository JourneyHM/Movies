...
var FavoriteButton = function(param) {
    var title = param.title, _param_color = param.color, color = _param_color === void 0 ? "blue" : _param_color;
    var _useState = _sliced_to_array((0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("blue"), 2), colorButton = _useState[0], setColor = _useState[1];
    var ButtonClass = classnames__WEBPACK_IMPORTED_MODULE_1___default()({
        ...
        "bg-blue-700 hover:bg-blue-900 border-blue-300": color === "blue",
        "bg-rose-700 hover:bg-rose-900 border-rose-300": color === "red"
    });
...
//# sourceMappingURL=components-FavoriteButton-FavoriteButton-stories.f28dcaabf699cca38367.hot-update.js.map